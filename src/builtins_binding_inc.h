...
xx("bvec2 lessThan(vec2 x, vec2 y);", builtin_lessThan_v2v2_runtime, builtin_lessThan_v2v2_eval)
xx("bvec3 lessThan(vec3 x, vec3 y);", builtin_lessThan_v3v3_runtime, builtin_lessThan_v3v3_eval)
xx("bvec4 lessThan(vec4 x, vec4 y);", builtin_lessThan_v4v4_runtime, builtin_lessThan_v4v4_eval)
xx("bvec2 lessThan(ivec2 x, ivec2 y);", builtin_lessThan_iv2iv2_runtime, builtin_lessThan_iv2iv2_eval)
xx("bvec3 lessThan(ivec3 x, ivec3 y);", builtin_lessThan_iv3iv3_runtime, builtin_lessThan_iv3iv3_eval)
xx("bvec4 lessThan(ivec4 x, ivec4 y);", builtin_lessThan_iv4iv4_runtime, builtin_lessThan_iv4iv4_eval)

xx("bvec2 lessThanEqual(vec2 x, vec2 y);", builtin_lessThanEqual_v2v2_runtime, builtin_lessThanEqual_v2v2_eval)
xx("bvec3 lessThanEqual(vec3 x, vec3 y);", builtin_lessThanEqual_v3v3_runtime, builtin_lessThanEqual_v3v3_eval)
xx("bvec4 lessThanEqual(vec4 x, vec4 y);", builtin_lessThanEqual_v4v4_runtime, builtin_lessThanEqual_v4v4_eval)
xx("bvec2 lessThanEqual(ivec2 x, ivec2 y);", builtin_lessThanEqual_iv2iv2_runtime, builtin_lessThanEqual_iv2iv2_eval)
xx("bvec3 lessThanEqual(ivec3 x, ivec3 y);", builtin_lessThanEqual_iv3iv3_runtime, builtin_lessThanEqual_iv3iv3_eval)
xx("bvec4 lessThanEqual(ivec4 x, ivec4 y);", builtin_lessThanEqual_iv4iv4_runtime, builtin_lessThanEqual_iv4iv4_eval)

xx("bvec2 greaterThan(vec2 x, vec2 y);", builtin_greaterThan_v2v2_runtime, builtin_greaterThan_v2v2_eval)
xx("bvec3 greaterThan(vec3 x, vec3 y);", builtin_greaterThan_v3v3_runtime, builtin_greaterThan_v3v3_eval)
xx("bvec4 greaterThan(vec4 x, vec4 y);", builtin_greaterThan_v4v4_runtime, builtin_greaterThan_v4v4_eval)
xx("bvec2 greaterThan(ivec2 x, ivec2 y);", builtin_greaterThan_iv2iv2_runtime, builtin_greaterThan_iv2iv2_eval)
xx("bvec3 greaterThan(ivec3 x, ivec3 y);", builtin_greaterThan_iv3iv3_runtime, builtin_greaterThan_iv3iv3_eval)
xx("bvec4 greaterThan(ivec4 x, ivec4 y);", builtin_greaterThan_iv4iv4_runtime, builtin_greaterThan_iv4iv4_eval)

xx("bvec2 greaterThanEqual(vec2 x, vec2 y);", builtin_greaterThanEqual_v2v2_runtime, builtin_greaterThanEqual_v2v2_eval)
xx("bvec3 greaterThanEqual(vec3 x, vec3 y);", builtin_greaterThanEqual_v3v3_runtime, builtin_greaterThanEqual_v3v3_eval)
xx("bvec4 greaterThanEqual(vec4 x, vec4 y);", builtin_greaterThanEqual_v4v4_runtime, builtin_greaterThanEqual_v4v4_eval)
xx("bvec2 greaterThanEqual(ivec2 x, ivec2 y);", builtin_greaterThanEqual_iv2iv2_runtime, builtin_greaterThanEqual_iv2iv2_eval)
xx("bvec3 greaterThanEqual(ivec3 x, ivec3 y);", builtin_greaterThanEqual_iv3iv3_runtime, builtin_greaterThanEqual_iv3iv3_eval)
xx("bvec4 greaterThanEqual(ivec4 x, ivec4 y);", builtin_greaterThanEqual_iv4iv4_runtime, builtin_greaterThanEqual_iv4iv4_eval)

xx("bvec2 equal(vec2 x, vec2 y);", builtin_equal_v2v2_runtime, builtin_equal_v2v2_eval)
xx("bvec3 equal(vec3 x, vec3 y);", builtin_equal_v3v3_runtime, builtin_equal_v3v3_eval)
xx("bvec4 equal(vec4 x, vec4 y);", builtin_equal_v4v4_runtime, builtin_equal_v4v4_eval)
xx("bvec2 equal(ivec2 x, ivec2 y);", builtin_equal_iv2iv2_runtime, builtin_equal_iv2iv2_eval)
xx("bvec3 equal(ivec3 x, ivec3 y);", builtin_equal_iv3iv3_runtime, builtin_equal_iv3iv3_eval)
xx("bvec4 equal(ivec4 x, ivec4 y);", builtin_equal_iv4iv4_runtime, builtin_equal_iv4iv4_eval)
xx("bvec2 equal(bvec2 x, bvec2 y);", builtin_equal_bv2bv2_runtime, builtin_equal_bv2bv2_eval)
xx("bvec3 equal(bvec3 x, bvec3 y);", builtin_equal_bv3bv3_runtime, builtin_equal_bv3bv3_eval)
xx("bvec4 equal(bvec4 x, bvec4 y);", builtin_equal_bv4bv4_runtime, builtin_equal_bv4bv4_eval)

xx("bvec2 notEqual(vec2 x, vec2 y);", builtin_notEqual_v2v2_runtime, builtin_notEqual_v2v2_eval)
xx("bvec3 notEqual(vec3 x, vec3 y);", builtin_notEqual_v3v3_runtime, builtin_notEqual_v3v3_eval)
xx("bvec4 notEqual(vec4 x, vec4 y);", builtin_notEqual_v4v4_runtime, builtin_notEqual_v4v4_eval)
xx("bvec2 notEqual(ivec2 x, ivec2 y);", builtin_notEqual_iv2iv2_runtime, builtin_notEqual_iv2iv2_eval)
xx("bvec3 notEqual(ivec3 x, ivec3 y);", builtin_notEqual_iv3iv3_runtime, builtin_notEqual_iv3iv3_eval)
xx("bvec4 notEqual(ivec4 x, ivec4 y);", builtin_notEqual_iv4iv4_runtime, builtin_notEqual_iv4iv4_eval)
xx("bvec2 notEqual(bvec2 x, bvec2 y);", builtin_notEqual_bv2bv2_runtime, builtin_notEqual_bv2bv2_eval)
