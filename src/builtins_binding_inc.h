...
xx("float radians(float degrees);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec2 radians(vec2 degrees);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec3 radians(vec3 degrees);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec4 radians(vec4 degrees);", builtin_not_implemented_runtime, builtin_not_implemented_eval)

xx("float degrees(float radians);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec2 degrees(vec2 radians);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec3 degrees(vec3 radians);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec4 degrees(vec4 radians);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
...
xx("float cos(float angle);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec2 cos(vec2 angle);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec3 cos(vec3 angle);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec4 cos(vec4 angle);", builtin_not_implemented_runtime, builtin_not_implemented_eval)

xx("float tan(float angle);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec2 tan(vec2 angle);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec3 tan(vec3 angle);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec4 tan(vec4 angle);", builtin_not_implemented_runtime, builtin_not_implemented_eval)

xx("float asin(float x);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec2 asin(vec2 x);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec3 asin(vec3 x);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec4 asin(vec4 x);", builtin_not_implemented_runtime, builtin_not_implemented_eval)

xx("float acos(float x);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec2 acos(vec2 x);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec3 acos(vec3 x);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec4 acos(vec4 x);", builtin_not_implemented_runtime, builtin_not_implemented_eval)

xx("float atan(float y, float x);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec2 atan(vec2 y, vec2 x);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec3 atan(vec3 y, vec3 x);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec4 atan(vec4 y, vec4 x);", builtin_not_implemented_runtime, builtin_not_implemented_eval)

xx("float atan(float y_over_x);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec2 atan(vec2 y_over_x);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec3 atan(vec3 y_over_x);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
xx("vec4 atan(vec4 y_over_x);", builtin_not_implemented_runtime, builtin_not_implemented_eval)
