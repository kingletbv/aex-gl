...
#define PIX_COORD(x,y) \
  -1.f + 2.f * ((.5f + (float)(x)) / (float)output_width), 1.f - 2.f * ((.5f + (float)(y)) / (float)output_height), -.5f, 1.f

  float verts[] = {
    PIX_COORD(16 + 0,  16 + 0),
    PIX_COORD(16 + 16, 16 + 0),
    PIX_COORD(16 + 0,  16 + 16),

    PIX_COORD(48 + 0,  16 + 0),
    PIX_COORD(48 + 0,  16 + 16),
    PIX_COORD(48 + 16, 16 + 0),

    PIX_COORD(16 + 0,  48 + 0),
    PIX_COORD(16 + 16, 48 + 0),
    PIX_COORD(16 + 16, 48 + 16),

    PIX_COORD(48 + 0,  48 + 0),
    PIX_COORD(48 + 16, 48 + 16),
    PIX_COORD(48 + 16, 48 + 0),

    PIX_COORD(16 + 16, 80 + 0),
    PIX_COORD(16 + 16, 80 + 16),
    PIX_COORD(16 + 0,  80 + 16),

    PIX_COORD(48 + 16, 80 + 0),
    PIX_COORD(48 + 0,  80 + 16),
    PIX_COORD(48 + 16, 80 + 16),

    PIX_COORD(16 + 0,  112 + 0),
    PIX_COORD(16 + 16, 112 + 16),
    PIX_COORD(16 + 0,  112 + 16),

    PIX_COORD(48 + 0,  112 + 0),
    PIX_COORD(48 + 0,  112 + 16),
    PIX_COORD(48 + 16, 112 + 16),
  ...
  glDrawArrays(GL_TRIANGLES, 0, sizeof(verts)/(4*sizeof(float)));
